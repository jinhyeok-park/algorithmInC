...
/*   Updated: 2023/06/11 15:30:12 by jinhyeok         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	img_load(t_game **game)
{
	...
	(*game)->img_coin = mlx_xpm_file_to_image((*game)->mlx, "./textures/coin.xpm",\
	 &img_width, &img_height);
	(*game)->img_player = mlx_xpm_file_to_image((*game)->mlx, "./textures/pack_right_open.xpm",\
	 &img_width, &img_height);
...
void	move_position(int x, int y, t_game **game)
{
	...
	{
		draw_img((*game)->player_position[1], (*game)->player_position[0], (*game)->img_player, (*game));
		game_fin(game);
	}
	draw_img((*game)->player_position[1], (*game)->player_position[0], (*game)->img_player, (*game));
}
