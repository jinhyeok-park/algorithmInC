...
/*   Updated: 2023/06/11 16:41:34 by jinhyeok         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	printf("_________game fin!! SUCCESS!!___________\n");
	printf("Your Steps     : %d \n", (*game)->steps);
	printf("Collected Coin : %d \n", (*game)->collected_coin);
...
{
	if (game->map[x][y] == 'E')
		draw_img(game->player_position[1], game->player_position[0], game->img_portal, game);
	else if (game->map[x][y] != 'E')
		draw_img(game->player_position[1], game->player_position[0], game->img_black, game);
}
